declare module 'gtfs-realtime-bindings' {
  /**
    ...
    class FeedMessage {
       ...
       */
      static create(
        properties?: FeedMessage$Properties
      ): FeedMessage
      /**
    ...
    class FeedHeader {
       ...
       */
      static create(
        properties?: FeedHeader$Properties
      ): FeedHeader
      /**
    ...
    class FeedEntity {
       ...
       */
      static create(
        properties?: FeedEntity$Properties
      ): FeedEntity
      /**
    ...
    class TripUpdate {
       ...
       */
      static create(
        properties?: TripUpdate$Properties
      ): TripUpdate
      /**
    ...
    class VehiclePosition {
       ...
       */
      static create(
        properties?: VehiclePosition$Properties
      ): VehiclePosition
      /**
    ...
    class TimeRange {
       ...
       */
      static create(
        properties?: TimeRange$Properties
      ): TimeRange
      /**
    ...
    class TripDescriptor {
       ...
       */
      static create(
        properties?: TripDescriptor$Properties
      ): TripDescriptor
      /**
    ...
    class VehicleDescriptor {
       ...
       */
      static create(
        properties?: VehicleDescriptor$Properties
      ): VehicleDescriptor
      /**
    ...
    class EntitySelector {
       ...
       */
      static create(
        properties?: EntitySelector$Properties
      ): EntitySelector
      /**
    ...
    class TranslatedString {
       ...
       */
      static create(
        properties?: TranslatedString$Properties
      ): TranslatedString
      /**
